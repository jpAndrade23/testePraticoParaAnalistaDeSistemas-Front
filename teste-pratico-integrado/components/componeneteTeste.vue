...
<Cabecalho /> 
    <div>
        ...
        <div  class="formulario">
            <div>
                <Formulario :id="curso.id"/>
            </div>
        </div>
        <div v-if="curso" class="formulario">
...
<style scoped>
    .topoPagina{
        ...
        color: white;
        box-shadow: rgba(0, 0, 0, 0.25) 400px 400px 0px 400px inset, rgba(0, 0, 0, 0.3) 400px 400px 0px 400px inset;
    }
    .tipo{
        font-size: 20px;
    }
